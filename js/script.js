...
let updateNavbar = () => {
    ...
    if (isLoggedIn === "true" && loggedInUser) {
        ...
        document.querySelector(".after1").style.display = "none";
        ...
        document.querySelector(".after1").style.display = "block";
...
let logOutUser = () => {
    ...
    document.querySelector(".login-nav").style.display = "block";
    document.querySelector(".login-nav1").style.display = "block";
...
let showNavbar = () => {
    ...
    if (isLoggedIn === "true" && loggedInUser) {
        ...
        document.querySelector(".login-nav1").style.display = "none";
    } else {
        document.querySelector("#Logout-nav").style.display = `none`;
        document.querySelector(".login-nav").style.display = "block";
        document.querySelector(".login-nav1").style.display = "block";
...
let openBookPage = () => {
    location.href = "flight_booking.html"
}

let showFlight = () =>{
    location.href = "flight_listing.html"
}
